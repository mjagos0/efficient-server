...
template<> ::Reset* Arena::CreateMaybeMessage<::Reset>(Arena*);
...
class Request final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::Reset* release_reset();
  ::Reset* mutable_reset();
  void set_allocated_reset(::Reset* reset);
  private:
  const ::Reset& _internal_reset() const;
  ::Reset* _internal_mutable_reset();
  public:
  void unsafe_arena_set_allocated_reset(
      ::Reset* reset);
  ::Reset* unsafe_arena_release_reset();
...
class Reset final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:Reset) */ {
 public:
...
inline ::Reset* Request::release_reset() {
  // @@protoc_insertion_point(field_release:Request.reset)
  if (_internal_has_reset()) {
    clear_has_msg();
    ::Reset* temp = _impl_.msg_.reset_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::Reset& Request::_internal_reset() const {
  return _internal_has_reset()
      ? *_impl_.msg_.reset_
      : reinterpret_cast< ::Reset&>(::_Reset_default_instance_);
}
inline const ::Reset& Request::reset() const {
  // @@protoc_insertion_point(field_get:Request.reset)
  return _internal_reset();
}
inline ::Reset* Request::unsafe_arena_release_reset() {
...
inline void Request::unsafe_arena_set_allocated_reset(::Reset* reset) {
  clear_msg();
  if (reset) {
    set_has_reset();
...
inline ::Reset* Request::_internal_mutable_reset() {
  if (!_internal_has_reset()) {
    clear_msg();
    set_has_reset();
    _impl_.msg_.reset_ = CreateMaybeMessage< ::Reset >(GetArenaForAllocation());
  }
  return _impl_.msg_.reset_;
}
inline ::Reset* Request::mutable_reset() {
  ::Reset* _msg = _internal_mutable_reset();
