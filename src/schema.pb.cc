...
static ::_pb::Metadata file_level_metadata_schema_2eproto[7];
...
const uint32_t TableStruct_schema_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Reset, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 11, -1, -1, sizeof(::Walk)},
  { 19, -1, -1, sizeof(::OneToOne)},
  { 27, -1, -1, sizeof(::OneToAll)},
  { 34, -1, -1, sizeof(::Reset)},
  { 40, -1, -1, sizeof(::Location)},
  { 48, -1, -1, sizeof(::Response)},
};
...
const char descriptor_table_protodef_schema_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\035\n\010oneToAll\030\003 \001(\0132\t.OneToAllH\000\022\027\n\005reset\030"
  "\004 \001(\0132\006.ResetH\000B\005\n\003msg\"5\n\004Walk\022\034\n\tlocati"
  "ons\030\001 \003(\0132\t.Location\022\017\n\007lengths\030\002 \003(\r\"E\n"
  "\010OneToOne\022\031\n\006origin\030\001 \001(\0132\t.Location\022\036\n\013"
  "destination\030\002 \001(\0132\t.Location\"%\n\010OneToAll"
  "\022\031\n\006origin\030\001 \001(\0132\t.Location\"\007\n\005Reset\" \n\010"
  "Location\022\t\n\001x\030\001 \001(\005\022\t\n\001y\030\002 \001(\005\"\215\001\n\010Respo"
  "nse\022 \n\006status\030\001 \001(\0162\020.Response.Status\022\016\n"
  "\006errMsg\030\002 \001(\t\022\034\n\024shortest_path_length\030\003 "
  "\001(\004\022\024\n\014total_length\030\004 \001(\004\"\033\n\006Status\022\006\n\002O"
  "K\020\000\022\t\n\005ERROR\020\001B \n\034cz.cvut.fel.esw.server"
  ".protoP\001b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_schema_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_schema_2eproto = {
    false, false, 536, descriptor_table_protodef_schema_2eproto,
    "schema.proto",
    &descriptor_table_schema_2eproto_once, nullptr, 0, 7,
...
class Request::_Internal {
 public:
  ...
  static const ::Reset& reset(const Request* msg);
};
...
void Request::set_allocated_reset(::Reset* reset) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  clear_msg();
  if (reset) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
...
Request::Request(const Request& from)
  ...
  switch (from.msg_case()) {
    ...
    case kReset: {
      _this->_internal_mutable_reset()->::Reset::MergeFrom(
...
Reset::Reset(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:Reset)
}
...
template<> PROTOBUF_NOINLINE ::Reset*
Arena::CreateMaybeMessage< ::Reset >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Reset >(arena);
}
